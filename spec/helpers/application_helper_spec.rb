...
describe ApplicationHelper do
  ...
  it "should have the Radiant::Configuration" do
    helper.configuration.should == Radiant::Configuration
  end
  ...
  it "should use the stored title if configured" do
    helper.configuration['admin.title'] = "My Title"
  ...
  it "should use the stored title if configured" do
    helper.configuration['admin.subtitle'] = "My Subtitle"
  ...
  #     Radiant::Configuration['pagination.max_list_length'] = 50
