...
describe ::Filters::TextFilter do
  class ReverseFilter < ::Filters::TextFilter
  ...
  it 'should return an array of filter_names of all available filters' do
    ::Filters::TextFilter.descendants_names.should include("Pseudo Markdown", "Pseudo Textile", "Really Custom", "Reverse")
  end

  it 'should filter text with base filter' do
    filter = ::Filters::TextFilter.new
