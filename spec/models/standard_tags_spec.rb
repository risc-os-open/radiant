...
describe "Standard Tags" do
  ...
  describe "<r:children:each>" do
    ...
    it 'should not list draft pages on dev.site.com when Radiant::Configuration["dev.host"] is set to something else' do
      Radiant::Configuration['dev.host'] = 'preview.site.com'
