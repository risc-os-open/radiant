module Radiant
  module Config
    class Definition
      ...
      #
      # The actual defining is done by Radiant::Configuration#define and usually in a block like this:
      #
      #   Radiant::Configuration.prepare do |config|
      #     config.namespace('users', :allow_change => true) do |users|
      #       users.define 'allow_password_reset?', :label => 'Allow password reset?'
      #     end
      #   end
      #
      # See the method documentation in Radiant::Configuration for options and conventions.
      #
